 ...
 */
public class RedRectangleFigure extends AttributedFigure {
    private Rectangle2D.Double rectangle;
    
    /** Creates a new instance. */
    public RedRectangleFigure() {
        this(0, 0, 0, 0);
    }
    
    public RedRectangleFigure(double x, double y, double width, double height) {
...
// CONNECTING
    ...
    protected void drawFill(Graphics2D g) {
        ...
        g.fill(r);
        this.setAttribute(FILL_COLOR, Color.RED);
    }
    ...
    public RedRectangleFigure clone() {
        RedRectangleFigure that = (RedRectangleFigure) super.clone();
